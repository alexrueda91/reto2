...
function consultar_todo(){
    $.ajax({ 
        url:"https://ge2b81f4928a07e-mibd01.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/cabin/cabin",
        type:"GET",
        datatype:"json",
...
function consultaID(id){
	...
	if(!validarCampo($("#id"))){
		...
		$.ajax({
			url: 'https://ge2b81f4928a07e-mibd01.adb.us-phoenix-1.oraclecloudapps.com/ords/admin/cabin/cabin'+ id.val(),			
			type: 'GET',
			dataType: 'json',
